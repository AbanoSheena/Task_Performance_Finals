...
class registerForCustomer extends JFrame{
    ...
    public registerForCustomer(){
        ...
        btnsubmit.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent a){
                ...
                try {                  
                    FileWriter fw = new FileWriter("registerForCustomer.txt", true);
                    ...
                    if(name1.getText().equals("")||pass1.getText().equals("")){
                        ...
                        dispose();
                        loginForCustomer lgc = new loginForCustomer();
                        lgc.setBounds(400,200,350,300);
                        lgc.setVisible(true);
                    }                   
                }catch (Exception e){}                
            }
